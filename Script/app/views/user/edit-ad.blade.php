	     	...
	     	@endif
			  ...
			  <div class="form-group ">
			    ...
			    <div class="col-sm-10">
			    	...
			    	<select <?php echo $styles; ?> id="quantity" name="quantity" class="input-sm btn-block">
