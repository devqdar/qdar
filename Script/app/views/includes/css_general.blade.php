<!-- Bootstrap core CSS -->
    ...
    <link href="{{ URL::asset('public/css/font-awesome.min.css') }}" rel="stylesheet">
     ...
     <!-- IcoMoon CSS -->
    <link href="{{ URL::asset('public/css/icomoon.css') }}" rel="stylesheet">
    
    <!-- Ion Icons CSS -->
    <link href="{{ URL::asset('public/css/ionicons.min.css') }}" rel="stylesheet">
...
<script type="text/javascript">
    ...
    var URL_BASE = "{{ URL::to('/') }}";
    // ReadMore
    var ReadMore = "{{ Lang::get('misc.view_more') }}";
    var ReadLess = "{{ Lang::get('misc.view_less') }}";
