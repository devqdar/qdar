	...
	<div class="caption row" style="margin-top: 15px;">
       ...
       @endif	{{-- Thumb verify 2 --}}
				  ...
				  <div class="caption">
    				...
    				<p>{{ $project->shots()->count() }} {{ Lang::choice('misc.shots_plural',$project->shots()->count()) }} - <small class="timeAgo" data="{{ date('c',strtotime( $project->shots{0}->created_project )) }}" ></small> </p>
