			...
			<ul class="margin-zero padding-zero btn-block">
				...
				<div class="media media-jobs">
					  ...
					  @if( Auth::user()->type_account == 3 )
				      					      	<img src="http://localhost/codecanyon/shotpro/public/avatar/{{Auth::user()->avatar}}" class="border-image-profile media-object img-circle image-dropdown job-image">
				      		 @else
								<img src="http://localhost/codecanyon/shotpro/public/avatar/job_avatar.jpg" class="border-image-profile media-object img-circle image-dropdown job-image">
										  @endif
										  </div>
